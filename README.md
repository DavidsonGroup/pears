...
| `demultiplex/` | Barcode table (`reads_barcodes.txt`), the barcode list used, and the read IDs and R1 reads that were demultiplexed (`target_read_ids.txt`, `target_R1.fastq`). |
